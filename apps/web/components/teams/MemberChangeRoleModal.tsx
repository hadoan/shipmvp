...
import { Button, Dialog, DialogContent, DialogFooter, Select } from "@shipmvp/ui";
        ...
        <>
          <div className="mb-4 sm:flex sm:items-start">
            <div className="text-center sm:text-left">
              <h3 className="text-emphasis text-semibold leading-20 text-xl font-medium" id="modal-title">
