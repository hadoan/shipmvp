...
import type { PendingMember } from "@shipmvp/types/teams";
import {
  Button,
...
import { Link } from "@shipmvp/ui/components/icon";
...
export default function MemberInvitationModal(props: MemberInvitationModalProps) {
  ...
  return (
    <Dialog
      ...
      <DialogContent type="creation" title={t("invite_team_member")} description={null}>
        <div>
