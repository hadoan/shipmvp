...
import { Badge, ConfirmationDialogContent, Dialog, DropdownActions, showToast, Table } from "@shipmvp/ui";
import { Edit, Trash } from "@shipmvp/ui/components/icon";
          ...
          {data.map((user) => (
            <Row key={user.email}>
              <Cell widthClassNames="w-auto">
                ...
                */}
                <div className="relative min-h-10 pl-12">
                  <img
