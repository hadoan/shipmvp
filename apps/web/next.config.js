...
const nextConfig = {
  ...
  modularizeImports: {
    "@shipmvp/ui/components/icon": {
      transform: "lucide-react/dist/esm/icons/{{ kebabCase member }}",
      preventFullImport: true,
    },
    "@shipmvp/features/insights/components": {
      transform: "@shipmvp/features/insights/components/{{member}}",
    ...
    // TODO: We need to have all components in `@shipmvp/ui/components` in order to use this
    // "@shipmvp/ui": {
    //   transform: "@shipmvp/ui/components/{{member}}",
    // },
  },
  images: {
    unoptimized: true,
  ...
  async redirects() {
    ...
    if (process.env.NEXT_PUBLIC_WEBAPP_URL === "https://app.shipmvp.co") {
      redirects.push(
        {
