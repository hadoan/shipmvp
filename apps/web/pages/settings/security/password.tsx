...
import { identityProviderNameMap } from "@shipmvp/features/auth/lib/identityProviderNameMap";
...
import { userMetadata } from "@shipmvp/prisma/zod-utils";
import { trpc } from "@shipmvp/trpc/react";
import { Alert, Button, Form, Meta, PasswordField, Select, SettingsToggle, showToast } from "@shipmvp/ui";
...
const PasswordView = () => {
  ...
  return (
    <>
      ...
      {user && user.identityProvider !== IdentityProvider.TEK ? (
        <div>
          <div className="mt-6">
            <h2 className=" text-emphasis text-lg font-medium leading-6">
