...
import { FULL_NAME_LENGTH_MAX_LIMIT } from "@shipmvp/lib/constants";
...
import { AlertTriangle, Trash2 } from "@shipmvp/ui/components/icon";
...
const ProfileView = () => {
  ...
  const onDeleteMeSuccessMutation = async () => {
    ...
    if (process.env.NEXT_PUBLIC_WEBAPP_URL === "https://app.shipmvp.com") {
  ...
  const isCALIdentityProviver = user?.identityProvider === IdentityProvider.TEK;
