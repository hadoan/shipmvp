...
const useGetBrandingColours = ({
  ...
  const theme = {
    light: {
      "myapp-brand": lightColourMap["500"],
      "myapp-brand-emphasis": lightColourMap["400"],
      "myapp-brand-subtle": lightColourMap["200"],
      "myapp-brand-text": getWCAGContrastColor(lightColourMap["500"]),
      "myapp-brand-accent": getWCAGContrastColor(lightColourMap["500"]),
    },
    dark: {
      "myapp-brand": darkColourMap["500"],
      "myapp-brand-emphasis": darkColourMap["600"],
      "myapp-brand-subtle": darkColourMap["800"],
      "myapp-brand-text": getWCAGContrastColor(darkColourMap["500"]),
      "myapp-brand-accent": getWCAGContrastColor(darkColourMap["500"]),
    },
  };
  return theme;
};
