...
import type { VerticalTabItemProps } from "@shipmvp/ui";
import { Button, ErrorBoundary, Skeleton, useMeta, VerticalTabItem } from "@shipmvp/ui";
import { User, Key, Users, Loader, Lock, ArrowLeft, Menu } from "@shipmvp/ui/components/icon";
      ...
      <div className="border-subtle mb-8 flex w-full items-center border-b pb-6">
        ...
        <div>
          {meta.title && isLocaleReady ? (
            <h1 className="font-myapp text-emphasis mb-1 text-xl font-bold leading-5 tracking-wide">
              {t(meta.title)}
            </h1>
          ) : (
