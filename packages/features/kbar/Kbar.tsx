...
import { appStoreMetadata } from "@shipmvp/app-store/appStoreMetaData";
import { useLocale } from "@shipmvp/lib/hooks/useLocale";
import { isMac } from "@shipmvp/lib/isMac";
import { Tooltip } from "@shipmvp/ui";
import { Search, ArrowUp, ArrowDown, CornerDownLeft, Command } from "@shipmvp/ui/components/icon";
      ...
      onRender={({ item, active }) =>
        typeof item === "string" ? (
          ...
          <div
            ...
            style={{
              background: active ? "var(--shipmvp-bg-subtle)" : `var(--shipmvp-bg-default)`,
              borderLeft: active ? "2px solid var(--shipmvp-border-default)" : "2px solid transparent",
              color: "var(--shipmvp-text)",
            }}
