...
<Examples title="Avatar style">
  <Example title="Small">
    <Avatar size="sm" alt="Avatar Story" gravatarFallbackMd5="Ui@TEK.com" />
  </Example>
  <Example title="Large">
    <Avatar size="lg" alt="Avatar Story" gravatarFallbackMd5="Ui@TEK.com" />
  </Example>
</Examples>
...
<Examples title="Avatar Group ">
  ...
  {
    image: "https://shipmvp.co/stakeholder/peer.jpg",
    alt: "Peer",
    title: "Peer Richelsen",
  },
  {
    image: "https://shipmvp.co/stakeholder/bailey.jpg",
    alt: "Bailey",
    title: "Bailey Pumfleet",
  },
  {
    image: "https://shipmvp.co/stakeholder/alex-van-andel.jpg",
    alt: "Alex",
    title: "Alex Van Andel",
  },
  {
    image: "https://shipmvp.co/stakeholder/ciaran.jpg",
    alt: "Ciarán",
...
<Canvas>
  <Story
    ...
    args={{
      size: 'sm',
      alt: 'Avatar Story',
      gravatarFallbackMd5: 'Ui@TEK.com',
    }}
    argTypes={{
      size: {
        control: {
