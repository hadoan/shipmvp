...
import { defaultAvatarSrc } from "@shipmvp/lib/defaultAvatarImage";
import { _UserModel as User } from "@shipmvp/prisma/zod";
import type { inferRouterOutputs } from "@shipmvp/trpc";
import { TRPCError } from "@shipmvp/trpc";
import { authedAdminProcedure } from "@shipmvp/trpc/server/procedures/authedProcedure";
import { router } from "@shipmvp/trpc/server/trpc";
